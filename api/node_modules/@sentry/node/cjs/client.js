...
class NodeClient extends core.BaseClient {
  ...
  /** Method that initialises an instance of SessionFlusher on Client */
   initSessionFlusher() {
    ...
    if (!release) {
      flags.IS_DEBUG_BUILD && utils.logger.warn('Cannot initialise an instance of SessionFlusher if no release is provided!');
    } else {
   ...
   */
   _captureRequestSession() {
    if (!this._sessionFlusher) {
      flags.IS_DEBUG_BUILD && utils.logger.warn('Discarded request mode session because autoSessionTracking option was disabled');
    } else {
