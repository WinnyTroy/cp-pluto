   ...
   constructor(_options) {;BrowserTracing.prototype.__init.call(this);
    ...
    if (_options) {
      if (_options.tracingOrigins && Array.isArray(_options.tracingOrigins) && _options.tracingOrigins.length !== 0) {
        ...
        flags.IS_DEBUG_BUILD && (this._emitOptionsWarning = true);
      }
    }
  ...
  /** Create routing idle transaction. */
   _createRouteTransaction(context) {
    ...
    if (finalContext.sampled === false) {
      flags.IS_DEBUG_BUILD && utils.logger.log(`[Tracing] Will not send ${finalContext.op} transaction because of beforeNavigate.`);
    }

    flags.IS_DEBUG_BUILD && utils.logger.log(`[Tracing] Starting ${finalContext.op} transaction on scope`);
